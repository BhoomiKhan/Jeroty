...
public class SubOilProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_oil_products);
        init();
    }
    ...
    private void setAdapter() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.sub_oil_products);
        listAdapter = new ListAdapter(subDryProductList, SubOilProducts.this);
